...
fizzy -l SEX -f MIM -i ../../DataCollections/Caporaso/caporaso-gut.biom \
  ...
  -n ${nsel} -s -r ../outputs/caporaso-gut-Results-Fizzy-MIM.biom
...
fizzy -l DIET_TYPE -f MIM -i ../../DataCollections/AmericanGut/AmericanGut-Gut-Diet.biom \
  ...
  -o ../outputs/AmericanGut-Gut-Diet-OV-Results-Fizzy-MIM.txt -n ${nsel} -s \
...
#  -m ../../DataCollections/AmericanGut/AmericanGut-Gut-Diet-OV.txt \
#  -o ../outputs/AmericanGut-Gut-Diet-OV-Results-Fizzy-JMI.txt -n ${nsel} -s \
